...
namespace OgreLib
{
                                     ...
                                     ISupportInitialize
    {
                    ...
                    (MethodInvoker)delegate
                                       {
                                           if (CreateDefaultScene)
                                           {
                                               ...
                                               //----------------------------------------------------- 
                                               //_sceneManager = _root.CreateSceneManager(SceneType.ST_INTERIOR, "SceneMgr");
                                               _sceneManager = Root.Singleton.CreateSceneManager("BspSceneManager");
                                               ...
                                               _camera.Position = new Vector3(0f, 0f, 3000f);
                                               // Look back along -Z
        ...
        public event Action LoadResourceEvent;
